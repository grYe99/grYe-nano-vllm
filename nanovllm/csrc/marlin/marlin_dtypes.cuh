...
template <>
class MarlinScalarType<nanovllm::kBFloat16.id()> {
 public:
...
template <>
class MarlinScalarType<nanovllm::kFE4M3fn.id()> {
 public:
...
template <>
class MarlinScalarType<nanovllm::kS8.id()> {
 public:
...
class MarlinScalarType2<nv_bfloat16>
    : public MarlinScalarType<nanovllm::kBFloat16.id()> {};

template <>
class MarlinScalarType2<__nv_fp8_e4m3>
    : public MarlinScalarType<nanovllm::kFE4M3fn.id()> {};

template <>
class MarlinScalarType2<int8_t> : public MarlinScalarType<nanovllm::kS8.id()> {};
